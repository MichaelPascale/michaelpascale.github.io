...
My research is concerned with decision-making in the context of human [information behavior](https://en.wikipedia.org/wiki/Information_behavior), which I approach from the perspective of cognitive neuroscience.
This primarily includes [information seeking](https://en.wikipedia.org/wiki/Information_seeking) and how it is influenced by curiosity, uncertainty, model-based learning, and valuation processes.
I am particularly interested [social epistemology](https://en.wikipedia.org/wiki/Social_epistemology) and the acquisition of knowledge as a human
